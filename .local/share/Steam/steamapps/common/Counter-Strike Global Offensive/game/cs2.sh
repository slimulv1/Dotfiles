...
if [ "$UNAME" == "Darwin" ]; then
   ...
   export DYLD_LIBRARY_PATH="${GAMEROOT}"/bin/osx64:$DYLD_LIBRARY_PATH
    ...
    if [ "$VERSION_CODENAME" != "sniper" ]; then
        ...
        echo
        echo "FATAL: It appears CS2 was not launched within the Steam for Linux sniper runtime environment."
...
export SDL_VIDEO_DRIVER=wayland # If you do not want to risk losing your account DO NOT do this. 
